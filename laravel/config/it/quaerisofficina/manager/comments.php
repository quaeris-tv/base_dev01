...
use Modules\Comment\Actions\SendNotificationsForApprovedCommentAction;
use Modules\Comment\Actions\RejectCommentAction;
use Modules\Comment\Actions\ApproveCommentAction;
use Modules\Comment\Actions\SendNotificationsForPendingCommentAction;
use Modules\Comment\Actions\ProcessCommentAction;
use Modules\Comment\Models\Reaction;
use Modules\Comment\Models\Comment;
use Modules\Comment\CommentTransformers\MarkdownToHtmlTransformer;
...
return [
    ...
    'models' => [
         ...
         * extend the `Modules\Comment\Models\Comment::class` model.
         */
        'comment' => Comment::class,

        /*
         * The model you want to use as a React model. It needs to be or
         * extend the `Modules\Comment\Models\Reaction::class` model.
         */
        'reaction' => Reaction::class,

        /*
         * The model you want to use as an subscription model. It needs to be or
         * extend the `Modules\Comment\Models\CommentNotificationSubscription::class` model.
         */
