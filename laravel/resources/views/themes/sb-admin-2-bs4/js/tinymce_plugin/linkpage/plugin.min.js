...
tinymce.PluginManager.add("linkpage", function (e) {
    function openmanager() {
        ...
        win = e.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: location.protocol + '//' + location.host + '/' + 'js/tinymce_plugin/pagemanager/dialog.php?type=2&editor=' + e.id + '&lang=' + tinymce.settings.language,
            filetype: 'file',
            width: 800,
            height: 500,
            inline: 1
    ...
    e.addButton("linkpage", {
        icon: "link",
        tooltip: "Insert/edit linkpage",
        shortcut: "Ctrl+P",
        onclick: t,
        ...
        cmd: "unlink",
        stateSelector: "a[href]"
    }), e.addShortcut("Ctrl+P", "", t), this.showDialog = t, e.addMenuItem("linkpage", {
        icon: "link",
        text: "Insert linkpage",
        shortcut: "Ctrl+P",
        onclick: t,
        stateSelector: "a[href]",
        context: "insert",
