...
$upload_dir = '/public/'; // path from base_url to upload base dir
$current_path = '/../../../../public/'; // relative path from filemanager folder to upload files folder
...
//Allowed extensions
//**********************
$ext_img = ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'tiff']; //Images
$ext_file = ['doc', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'ppt', 'pptx']; //Files
$ext_video = ['mov', 'mpeg', 'mp4', 'avi', 'mpg', 'wma']; //Videos
$ext_music = ['mp3', 'm4a', 'ac3', 'aiff', 'mid']; //Music
$ext_misc = ['zip', 'rar', 'gzip']; //Archives
