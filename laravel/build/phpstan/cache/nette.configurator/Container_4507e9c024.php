...
class Container_4507e9c024 extends _PHPStan_5c71ab23c\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService044(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_4507e9c024 $container)
			{
	...
	public function createServiceContainer(): Container_4507e9c024
	{
		return $this;
	}
