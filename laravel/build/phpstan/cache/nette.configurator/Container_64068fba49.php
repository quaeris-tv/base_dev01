...
class Container_64068fba49 extends _PHPStan_5c71ab23c\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService044(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_64068fba49 $container)
			{
	...
	public function createServiceContainer(): Container_64068fba49
	{
		return $this;
	}
