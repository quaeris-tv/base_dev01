...
class Container_127d0c2823 extends _PHPStan_5c71ab23c\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'scanFiles' => ['D:\var\www\_bases\base_dev01\laravel\Modules\Xot\Helpers\Helper.php'],
			'scanDirectories' => [],
			'parallel' => [
				'jobSize' => 20,
	...
	public function createService044(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_127d0c2823 $container)
			{
	...
	public function createServiceContainer(): Container_127d0c2823
	{
		return $this;
	}
